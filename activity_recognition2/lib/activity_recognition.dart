...
part 'package:activity_recognition2/src/ar_channel.dart';
part 'package:activity_recognition2/src/ar_domain.dart';
...
class ActivityRecognition {
  ...
  // By default the foreground service is enable, which allows the updates to be streamed while
  // the app runs in the background. 
  // The programmer can choose to not enable to foreground service, if they so choose.
